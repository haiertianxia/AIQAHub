...
class WeComNotifier(NotificationProvider):
    channel = "wecom"
    ...
    def send(
        ...
        *,
        ...
        if not url:
            raise ValidationError("wecom notification is not configured")
        ...
        try:
            ...
            raise ValidationError(f"wecom notification failed: {exc}") from exc
